...
Scene* HelloWorld::createScene()
{
    ...
    m_pLayer = HelloWorld::create();
    
    // add layer as a child to scene
    scene->addChild(m_pLayer);
...
bool HelloWorld::init()
{
    ...
    startBtn->addTouchEventListener(this,toucheventselector(HelloWorld::startGame));
    /*
...
void HelloWorld::startGame(Object* pSender,TouchEventType type)
{
    //MainUI::init();
